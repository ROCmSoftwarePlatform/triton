...
module attributes {"triton_gpu.num-warps" = 1 : i32} {
  // CHECK-LABEL: convert_dot_mmav3
  tt.func @convert_dot_mmav3(%A: tensor<32x32xf16, #blocked0>, %B: tensor<32x32xf16, #blocked0>) {
...
module attributes {"triton_gpu.num-warps" = 1 : i32} {
  ...
  tt.func @convert_layout_mmav3_blocked(%arg0: tensor<32x32xf32, #mma>) {
