...
// It accompanies the AMDGPUPerformInThreadTranspose pass to transpose K-major tensor
...
// AMDGPUPerformInThreadTranspose: #blocked1 = #triton_gpu.blocked<{sizePerThread =
