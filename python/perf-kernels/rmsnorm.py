...
def model_benchmark_configs(args):
    ...
    if args.model == "all":
        for _, config in configs.items():
            ...
            x_vals_list.append((batch_size * seq_len, config["hidden_size"]))
    else:
...
def parse_args():
    ...
    parser.add_argument('-model', "--model", type=str, default=None, help=model_help)
    ...
    parser.add_argument(
        '-sl', "--sequence_length", type=int, default=0,
